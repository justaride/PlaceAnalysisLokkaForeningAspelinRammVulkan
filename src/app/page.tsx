        ...
        <Container>
          <div className="max-w-3xl">
            <h1 className="mb-6 text-5xl font-bold leading-tight">
              Aspelin Ramm - Vulkan Oslo
            </h1>
            <p className="mb-8 text-xl text-white/90">
              Omfattende placeanalyser og eiendomsinformasjon for Aspelin Ramm sin
              portefølje på Vulkan. Utforsk demografi, markedsdata og utviklingstrender
              for eiendommene i dette unike området.
            </p>
